...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  void _applyFilter() {
    _filtered = _all.where((t) {
      ...
      if (_filterAccount != null && t['account_id'] != _filterAccount)
        return false;
      if (_filterCategory != null && t['category_id'] != _filterCategory)
        return false;
      // item 12: date range
  ...
  Future<void> _showChangeAccountDialog(
    ...
    if (selectedAccountId == null ||
        !_accounts.any((a) => a['id'] == selectedAccountId)) {
    ...
    try {
      ...
      debugPrint(
          '[TransactionsScreen] Could not update transaction account: $e');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
            'Transactions${_filtered.length != _all.length ? ' (${_filtered.length})' : ''}'),
                ...
                return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                          ...
                          child: Icon(_txIcon(type), color: col, size: 18)),
                      title: Text(desc,
